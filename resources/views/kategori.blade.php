...
<head>
  ...
  <title>PT Fasya Pratama Solusindo</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt nav-item has-treeview"></i>
              <p>
                Dashboard
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ketersediaan Barang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
