            ...
            <div class="card card-success">
              ...
              <div class="col-sm-10">
                <div class="form-group">
                  ...
                  <select class="select2" multiple="multiple" data-placeholder="Pilih Barang" style="width: 100%;">
                    @foreach($inventory as $inv)
                    <option value="{{ $inv->id }}">{{ $inv->nama_produk}}</option>
                    @endforeach
                  </select>
                </div>
                    ...
                    <div class="col-sm-">
                      ...
                      <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" <input checked="checked" name="valid" type="checkbox" value="1">
                          <label class="form-check-label">Validasi Pesanan  </label>
                        </div>
                      </div>
                      <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Checkout</button>
                </div>
              </form></div></div>
            </div>
...
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="exampleModal" id="exampleModal" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Penawaran Telah Dibuat</h3>
...
<div class="wrapper">
  ...
  <!-- /.content -->
      ...
      <div class="row no-print pull right">
                  ...
                  <button type="button" class="btn btn-danger float-right" style="margin-right: 1px;">
...
<script type="text/javascript">
  $( ".select2" ).on('change', function(){
    //selected_value = $('.select2 option[value=' + objValue + ']').attr('selected', true);
    selected_value = $(".select2").val();
