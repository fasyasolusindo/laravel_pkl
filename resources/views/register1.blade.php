...
<center><div class="login-box" style="transform: translateY(20%);">
  ...
  <div class="card">
    <div class="card-body login-card-body-rounded">
      ...
      <h4><b><p class="login-box-msg text-primary">Register</p></b></h4>
      </div>
      <form action="../../index3.html" method="post">
         ...
         <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="ID Member">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div  class="card-footer">
          <div class="col-6">
            <button type="submit" class="btn btn-primary btn-block btn-flat-rounded">Register</button>
          </div>
        </div>
          <!-- /.col -->
        </div>
